...
public class SendOut_Steps extends Base_Steps{
    ...
    public void verifyIsInDomesticSendoutPage(){
        if(isVisible(sendOutPageObjects.sendOutTransaction(), getText(sendOutPageObjects.sendOutTransaction()))){
            ExtentReporter.logPass("DS_TC_01", "\"Successfully Navigate for SendOut Domestic Page");
        }
    }
    public void sendOutTransactionOption ()throws Exception{
        click(sendOutPageObjects.yesRadioButton(), "Yes Button ");
            ...
            assertEqual(getText(sendOutPageObjects.branchNotFoundText()), "Branch not found");
            ExtentReporter.logPass("DS_TC_02", "Succesfully Verified");
            type(sendOutPageObjects.inputReasonField(), "Branch field", propertyReader.getproperty("Reason"));
        }

    public void searchKYCSender()throws Exception {
    ...
    public void addReceiverNew()throws Exception {
        if(isVisible(sendOutPageObjects.receiverInformation(), getText(sendOutPageObjects.receiverInformation()))){
            ...
            type(sendOutPageObjects.r_HouseNoStreetBarangaySitio(),"Receiver House No. Street/Barangay/Sitio ", propertyReader.getproperty("HouseNoStreetBarangaySitio"));         click(sendOutPageObjects.r_birthdate_Field(), "Receiver Birthdate field ");
    ...
    public void otherInformationInputs()throws Exception {
