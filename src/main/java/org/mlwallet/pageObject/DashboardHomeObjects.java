...
public class DashboardHomeObjects extends AppiumDriverManager {
...
//=================================== Icons ==================================================================//
    ...
    //
    public WebElement objGetStartedBtn(){
        return driver.findElement(By.xpath("(//android.view.ViewGroup[@content-desc=\"Get's Started\"]"));
    }
}
