...
public class SendOut_Tests extends BaseTest {
    ...
    public void navigationFOrSendOutDomestic_DS_TC_01()throws Exception{
        if(this.homeSteps.isInHomePage()){
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 8, description = "To Validate Cancel No SendOut Transaction")
