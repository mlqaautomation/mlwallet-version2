...
public class SendOut_Tests extends BaseTest {
    ...
    @Test(dependsOnMethods = "loginGoogle" , priority = 9, description = "Verify SendOut Transaction Option")
    ...
    @Test(dependsOnMethods = "loginGoogle" , priority = 2, description = "Verify Search KYC (Sender)")
    ...
    @Test(dependsOnMethods = "loginGoogle" , priority = 3, description = "Verify Add Receiver New")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 4, description = "Verify Search Receivers")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 5, description = "Verify Other Information Inputs")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 6, description = "To Validate Cancel SendOut Transaction")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 8, description = "To Validate Submit then Cancel SendOut Transaction")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 10, description = "To Validate kyc from the Watch List")
    ...
    @Test(dependsOnMethods = "loginGoogle", priority = 11, description = "To Validate The Same Transaction")
