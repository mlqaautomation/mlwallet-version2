...
//    }
    ...
    public void buyELoadPromoConfirmationPopupValidation_BE_11() throws Exception {
        buyELoad.buyELoadPromoConfirmationPopupValidation_BE_TC_24();
    }
    @Test(priority = 12, description = "buyELoadInAppOTPPageUIValidation_BE_12")
    public void buyELoadInAppOTPPageUIValidation_BE_12() throws Exception {
        buyELoad.buyELoadInAppOTPPageUIValidation_BE_TC_25();
    }
    @Test(priority = 13, description = "buyELoadRecentTransactionUIValidation_BE_13")
    public void buyELoadRecentTransactionUIValidation_BE_13() throws Exception {
        buyELoad.buyELoadRecentTransactionUIValidation_BE_TC_27();
    }
    @Test(priority = 14, description = "buyELoadTransactionDetailsUIValidation_BE_14")
    public void buyELoadTransactionDetailsUIValidation_BE_14() throws Exception {
        buyELoad.buyELoadTransactionDetailsUIValidation_BE_TC_28();
    }
    @Test(priority = 15, description = "buyELoadNewTransactionBtnFunctionality_BE_15")
    public void buyELoadNewTransactionBtnFunctionality_BE_15() throws Exception {
        buyELoad.buyELoadNewTransactionBtnFunctionality_BE_TC_66();
    }
    @Test(priority = 16, description = "buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_16")
    public void buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_16() throws Exception {
        buyELoad.buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_TC_091();
    }
    @Test(priority = 17, description = "buyELoadTransactionForBranchVerifiedTier_BE_17")
    public void buyELoadTransactionForBranchVerifiedTier_BE_17() throws Exception {
        buyELoad.buyELoadTransactionForBranchVerifiedTier_BE_TC_42();
    }
    @Test(priority = 18, description = "buyELoadTransactionForSemiVerifiedTier_BE_18")
    public void buyELoadTransactionForSemiVerifiedTier_BE_18() throws Exception {
        buyELoad.buyELoadTransactionForSemiVerifiedTier_BE_TC_30();
    }
    @Test(priority = 19, description = "buyELoadBuyerTierVerifiedTier_BE_19")
    public void buyELoadBuyerTierVerifiedTier_BE_19() throws Exception {
...
//    }
    ...
    @Test(priority = 7, description = "buyELoadSearchUnFavoriteContact_BE_7")
    public void buyELoadSearchUnFavoriteContact_BE_7() throws Exception {
        buyELoad.buyELoadSearchUnFavoriteContact_BE_TC_23();
    }
    @Test(priority = 8, description = "buyELoadTransactionOTPCancelBtnFunctionality_BE_8")
    public void buyELoadTransactionOTPCancelBtnFunctionality_BE_8() throws Exception {
